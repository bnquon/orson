export namespace api {
	...
	export class APIError {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.topicDiagnostics = this.convertValues(source["topicDiagnostics"], TopicDiagnostic);
	    }
	...
	export class TopicDiagnostic {
	    kind: string;
	    topic?: string;
	    roles?: string[];

	    static createFrom(source: any = {}) {
	        return new TopicDiagnostic(source);
	    }
	...
	export class ScenarioYAMLData {
	    yaml?: string;
	    warnings?: ScenarioWarning[];
	    diagnostics?: ScenarioDiagnostic[];
	
	    static createFrom(source: any = {}) {
	        return new ScenarioYAMLData(source);
	    }
	...
	export class ScenarioYAMLResponse {
	    ok: boolean;
	    data?: ScenarioYAMLData;
	    error?: APIError;
	
	    static createFrom(source: any = {}) {
	        return new ScenarioYAMLResponse(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.ok = source["ok"];
	        this.data = this.convertValues(source["data"], ScenarioYAMLData);
	        this.error = this.convertValues(source["error"], APIError);
	    }
